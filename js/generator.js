...
export function generateSvgHTML1(fillColor) {
  ...
  const svgContent = `<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="90" height="90" viewBox="-3.374 5.061 1024 1024" preserveAspectRatio="xMidYMid meet" style="max-width: 90px; max-height: 90px;">
    <g transform="translate(1,1024) scale(0.1,-0.1)" fill="${fillColor}">
